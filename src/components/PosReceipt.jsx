...
const S = {
  ...
  grandRow: { display: "flex", justifyContent: "space-between", alignItems: "baseline", padding: "14px 0 6px", borderTop: "2px solid #0f172a", marginTop: 8 },
  grandLabel: { fontWeight: 800, fontSize: 14, color: "#0f172a", letterSpacing: 0.5 },
  grandAmt: { fontFamily: "'JetBrains Mono', monospace", fontWeight: 900, fontSize: 22, color: "#0f172a" },
      ...
      <div style={S.wrap} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={S.body}>
          ...
          <div>
            ...
            {paid > 0 && <div style={{ ...S.totalsRow, marginTop: 6 }}><span style={{ color: "#22c55e", fontSize: 11 }}>Paid</span><span style={{ color: "#22c55e", fontFamily: "'JetBrains Mono', monospace", fontSize: 11 }}>{money(paid)}</span></div>}
