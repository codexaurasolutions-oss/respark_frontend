export const SETTINGS_WORKSPACE_SECTIONS = [
  ...
  { key: "coupons", label: "Coupons & Gift Cards", to: "/admin/settings/coupons", hint: "Promo rules" },
  { key: "referrals", label: "Referral Program", to: "/admin/settings/referrals", hint: "Referral benefits" },
